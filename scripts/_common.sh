...
install_dependance() {
    ...
    sudo -u $seafile_user pip3 install --user --no-warn-script-location --upgrade future mysqlclient pymysql PyMySQL Pillow pylibmc captcha Jinja2 SQLAlchemy psd-tools django-pylibmc django-simple-captcha python3-ldap pycryptodome==3.12.0 cffi==1.14.0
